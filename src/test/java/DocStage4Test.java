...
public class DocStage4Test{
    ...
    public void getWordsTest(){
        ...
        assertEquals(words,this.doc.getWords());
    }
    @Test
    public void wordCount() throws URISyntaxException {
        DocumentImpl newDoc = new DocumentImpl(new URI("Many_Words"), this.harryPotter, null);

        assertEquals(14, newDoc.wordCount("Harry"));
        assertEquals(6, newDoc.wordCount("been"));
        assertEquals(6, newDoc.wordCount("Dudley"));
        assertEquals(4, newDoc.wordCount("Dudleys"));
